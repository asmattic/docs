...
Using from your editor

 - `Install ShellCheck extension in your editor <https://github.com/koalaman/shellcheck#user-content-in-your-editor>`_

Use live online

 - `ShellCheck live online <https://www.shellcheck.net/>`_

Integrate with build systems, Travis CI, Docker, etc.

 - `Integrating with ShellCheck <https://github.com/koalaman/shellcheck/wiki/Integration>`_
